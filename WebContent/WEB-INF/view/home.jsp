...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/angular-material.css">
...
<!--  <script src="js/lumx.js"></script> -->
 ...
 <script src="<%=request.getContextPath()%>/resources/js/mfb-directive.js"></script>
  ...
  <script src="<%=request.getContextPath()%>/resources/js/angular-material.min.js"></script>
